      ...
      <Modal
        ...
        <TouchableOpacity activeOpacity={1} style={styles.bg} onPress={this.props.hide}>
          <TouchableOpacity style={styles.dialog}>
            <TouchableOpacity activeOpacity={0.9} style={styles.recover} onPress={this.props.recoverDiary}>
              <Text style={{fontSize: theme.text.xxlgFontSize, color: 'red'}}>恢复</Text>
            </TouchableOpacity>
            <View style={{height: 0.5, backgroundColor: '#f8f8f8'}} />
            <TouchableOpacity activeOpacity={0.9} style={styles.delete} onPress={this.props.deleteDiary}>
              <Text style={{fontSize: theme.text.xxlgFontSize}}>彻底删除</Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.9} style={styles.cancelItem} onPress={this.props.hide}>
